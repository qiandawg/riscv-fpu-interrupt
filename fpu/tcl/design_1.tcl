...
\
  ...
  connect_bd_intf_net -intf_net axi_clock_converter_0_M_AXI [get_bd_intf_pins axi_fifo_mm_s_0/S_AXI] [get_bd_intf_pins axi_clock_converter_0/M_AXI]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets ps7_0_axi_periph_M00_AXI] [get_bd_intf_pins full_radio_0/S00_AXI] [get_bd_intf_pins system_ila_0/SLOT_1_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M01_AXI [get_bd_intf_pins ps7_0_axi_periph/M01_AXI] [get_bd_intf_pins axi_clock_converter_0/S_AXI]
  ...
  connect_bd_net -net axi_fifo_mm_s_0_axi_str_rxd_tready  [get_bd_pins axi_fifo_mm_s_0/axi_str_rxd_tready] \
  [get_bd_pins axis_register_slice_0/m_axis_tready]
  connect_bd_net -net axi_gpio_0_gpio_io_o  [get_bd_pins axi_gpio_0/gpio_io_o] \
  [get_bd_pins xpm_cdc_gen_1/src_rst]
  connect_bd_net -net axis_register_slice_0_m_axis_tdata  [get_bd_pins axis_register_slice_0/m_axis_tdata] \
  [get_bd_pins axi_fifo_mm_s_0/axi_str_rxd_tdata]
  connect_bd_net -net axis_register_slice_0_m_axis_tvalid  [get_bd_pins axis_register_slice_0/m_axis_tvalid] \
  [get_bd_pins util_vector_logic_0/Op1]
  connect_bd_net -net full_radio_0_m_axis_tdata  [get_bd_pins full_radio_0/m_axis_tdata] \
  [get_bd_pins axis_register_slice_0/s_axis_tdata] \
  ...
  [get_bd_pins axis_register_slice_0/s_axis_tvalid] \
  ...
  [get_bd_pins axi_fifo_mm_s_0/axi_str_rxd_tvalid]
  ...
  connect_bd_net -net xpm_cdc_gen_1_dest_rst_out  [get_bd_pins xpm_cdc_gen_1/dest_rst_out] \
