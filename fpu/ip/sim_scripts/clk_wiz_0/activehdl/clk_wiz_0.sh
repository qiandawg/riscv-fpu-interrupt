...
#
# Script generated by Vivado on Wed Jul 09 21:36:36 -0500 2025
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/JHU_Classes/en-525-612-riscv-cpu-ed1b98ecbf9f/en-525-612-riscv-cpu-ed1b98ecbf9f/RTL/CPUs/RISCVpipelinedRV32IMF/RISCVpipelinedRV32IMF.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
