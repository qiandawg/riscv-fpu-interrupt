...
#
# Script generated by Vivado on Fri Jul 11 01:53:52 -0500 2025
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/JHU_Classes/ILA_RISCVpipelinedRV32IMF/ILA_RISCVpipelinedRV32IMF.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
